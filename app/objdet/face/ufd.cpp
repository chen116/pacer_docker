...
void detectAndDraw( UMat& img, CascadeClassifier& cascade,
                    CascadeClassifier& nestedCascade,
                    double scale, bool tryflip );

string cascadeName = "/OpenCV/data/haarcascades/haarcascade_frontalface_alt.xml";
string nestedCascadeName = "/OpenCV/data/haarcascades/haarcascade_eye_tree_eyeglasses.xml";
...
int main( int argc, const char** argv )
{
    ...
    cv::CommandLineParser parser(argc, argv,
        "{cascade|/OpenCV/data/haarcascades/haarcascade_frontalface_alt.xml|}"
        "{nested-cascade|/OpenCV/data/haarcascades/haarcascade_eye_tree_eyeglasses.xml|}"
    ...
    {
        if( inputName.empty() )
            inputName = "/OpenCV/samples/data/lena.jpg";
                    ...
                    double scale, bool tryflip )
{
    ...
    printf( "gpu detection time = %g ms\n", t*1000/getTickFrequency());
    ...
    // putText(img, format("OpenCL: %s, fps: %.1f", ocl::useOpenCL() ? "ON" : "OFF", avgfps), Point(50, 30),
