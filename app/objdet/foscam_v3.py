...
class FoscamCamera(object):
    ...
    def start_cruise(self,cruise,callback=None):
        return self.execute_command('ptzStartCruise',{'mapName':cruise},callback=callback)
    ...
    def get_cruise_map_info(self,cruise_name,callback=None):
        return self.execute_command('ptzGetCruiseMapInfo',{'name':cruise_name},callback=callback)
    def set_preset_point(self,name,callback=None):
        return self.execute_command('ptzAddPresetPoint',{'name':name},callback=callback)
    def delete_preset_point(self,name,callback=None):
        return self.execute_command('ptzDeletePresetPoint',{'name':name},callback=callback)
    def set_cruise(self, cruisemap, callback=None):
